...
[Issues](https://github.com/vishruth-thimmaiah/converse/issues) that 
...
- Open an [Issue](https://github.com/vishruth-thimmaiah/converse/issues/new).
- Provide as much context as you can about what you're running into.
- Provide project and platform versions (cargo, gtk, window manager), depending on what seems relevant.
...
A
 good bug report shouldn't leave others needing to chase you up for more
...
existing for your bug or error in the [bug tracker](https://github.com/vishruth-thimmaiah/converse/issues?q=label%3Abug).
...
- Collect information about the bug:
  ...
  - OS, Window Manager, Platform and Version (x86, ARM)
...
public. Instead sensitive bugs must be sent by email to <vishruththimmaiah@gmail.com>.
...
<!-- You might 
want to create an issue template for bugs and errors that can be used as
 a guide and that defines the structure of the information to be 
...
- Make sure that you are using the latest version.
- Perform a [search](https://github.com/vishruth-thimmaiah/converse/issues) to see 
if the enhancement has already been suggested. If it has, add a comment 
to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project. It's up 
to you to make a strong case to convince the project's developers of the
 merits of this feature. Keep in mind that we want features that will be
 useful to the majority of our users and not just a small subset. If 
you're just targeting a minority of users, consider writing an 
add-on/plugin library.

<!-- omit in toc -->
#### How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [GitHub issues](https://github.com/vishruth-thimmaiah/converse/issues).
